...
namespace CarreraAlgoritmos
{
    ...
    public partial class Form1 : Form
    {
        ...
        public void Generar() {
            ...
            for (int i = 0; i < arreglo.Length; i++)
            {
                ...
                ArregloBox.Text += "[" + arreglo[i] + "] ";
            }
        }

        public void Limpiar() {
            BinariaBox.Text = BurbujaBox.Text = QuiksortBox.Text = secuencialBox.Text = InsercionBox.Text = "";
            labelQuik.Text= labelBinaria.Text = labelBurbuja.Text = labelInsercion.Text = labelSecuencial.Text = "";
            labelres.Visible = false;
            labelQuik.ForeColor = labelBinaria.ForeColor = labelBurbuja.ForeColor = labelInsercion.ForeColor = labelSecuencial.ForeColor = Color.Black;
            t_memoria.Text = "Total de memoria consumida:";
            t_memoria.Visible = false;
        }
    ...
    public static int BuscarSecuencial(int[] arreglo, int elemento)
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            t_memoria.Visible = true;
            labelres.Visible=true;
            var stopwatch = new Stopwatch();
            int busqueda = int.Parse(buscartxt.Text.ToString());
            ...
            if (tareaBusquedaSecuencial.Result < 0) secuencialBox.Text = "Elemento NO encontrado";
            else secuencialBox.Text = "Elemento encontrado en la posicion " + tareaBusquedaSecuencial.Result;
            ...
            Console.WriteLine(stopwatch.Elapsed.TotalMilliseconds.ToString());
            if (tareaBusquedaBinaria.Result < 0) BinariaBox.Text = "Elemento NO encontrado";
            else BinariaBox.Text = "Elemento encontrado en la posicion " + tareaBusquedaBinaria.Result;
            ...
            labelQuik.Text = "QuikSort: " + stopwatch.Elapsed + " (" + (float.Parse(memoriaConsumidaMetodoQuikSort.ToString()) / 1000000) + " MB)"; ;
            float memoriaquik = (float.Parse(memoriaConsumidaMetodoQuikSort.ToString()) / 1000000);
            t_memoria.Text +=" "+ (memoriaBinaria + memoriaBurbuja + memoriaquik + memoriaInsercion + memoriaSecuencial).ToString()+" MB";
            ...
            for (int i = 0; i < arreglo.Length; i++)
            {
                ...
                QuiksortBox.Text += "[" + arreglo2[i] + "] ";
            }
            BurbujaBox.Text = QuiksortBox.Text;
            InsercionBox.Text= QuiksortBox.Text;
            ...
            switch (BuscarGanador(time)) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    labelQuik.ForeColor = Color.Green;
                    labelQuik.Text += " (GANADOR)";
                    break;
